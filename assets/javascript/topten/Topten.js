async function Topten() {
    try {
        ...
        document.querySelector("#toptenSwiper-wrapper").insertAdjacentHTML("afterbegin",Topten.join(" "));
        

    } catch (error) {
        console.log(error.message);
    }
    var swiper = new Swiper("#toptenSwiper", {
      slidesPerView: 6,
      spaceBetween: 20,
      pagination: {
        el: "#toptenSwiper-pagination",
        clickable: true,
      },
      navigation: {
        nextEl: "#toptenSwiper-next",
        prevEl: "#toptenSwiper-prev",
      },
      breakpoints:{
        0:{
          slidesPerView:2,
