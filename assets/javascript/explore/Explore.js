async function Explorevideos() {
    try {
        ...
        let Explorevideos = res.exploring.map(function(elem){
            return `
        ...
        document.querySelector("#exploreSwiper-wrapper").insertAdjacentHTML("afterbegin",Explorevideos.join(" "));
